...
{{< cards >}}
	{{< card link="" title="fs模拟器开发" icon="document-text">}}
	{{< card link="" title="rk628D芯片驱动移植" icon="document-text">}}
{{< /cards >}}

{{< callout icon="bookmark" type="important">}}学习文档{{< /callout >}}
{{< cards >}}
	{{< card link="" title="linux GPIO系统框架" icon="document-text">}}
	{{< card link="" title="uboot 启动流程分析" icon="document-text">}}
{{< /cards >}}
...
{{< hextra/hero-badge link="../../tags/2026">}}
  <div class="hx:w-2 hx:h-2 hx:rounded-full hx:bg-primary-400"></div>
2026
{{< icon name="arrow-circle-right" attributes="height=14">}}
{{< /hextra/hero-badge >}}
